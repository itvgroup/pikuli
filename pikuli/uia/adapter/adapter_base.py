...
class AdapterBase(object):
    ...
    @classmethod
    def __cls_init_by_meta__(cls):
        """
        This method is called in derived classses :class:`mono.Adapter` and :class:`windows.Adapter`
        by means of metaclass :class:`AdapterMeta`. Build-function are defined in derived classses.
        """
    ...
    def is_automation_element(cls, obj):
        raise NotImplemente("abstract method")
